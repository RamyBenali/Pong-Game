...
// Procedure pour initialiser les donn�s pricipale du jeu
void InitialiserPong(void)
{
    InitWindow(0, 0, "Pong");
    // Calculer les tailles de l'�cran et donner des dimensions ou formes principales.
...
// proc�dure pour afficher le terrain de jeu
void terrainDeJeu (void)
{
